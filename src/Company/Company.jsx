...
useEffect(()=>{
  ...
  <div className='company'>
    <div className='section'>
      <div className='com'/>
    <h1 className='text-head'>our <span>Company</span> <hr /></h1> 
      ...
      <img src={IoT} alt='company'/>  
        <p>
        Vitel Wireless Limited has become a renowned company in the industry for our expertise and has contributed to several standards and innovations in data gathering and analysis in the African continent. Vitel has a Private Network Lines (Local Exchange Operator) service license and has had experience in the telecommunication business. Our vision is to leverage the dominance of large telecom operators in delivering cost-efficient services and establish interoperability with these operators for new, fast-growing services to the consumer.</p>
      </div>
      <svg className='svm' viewBox="0 0 190 150" xmlns="http://www.w3.org/2000/svg">
  <path fill="whitesmoke" d="M21.7,-36.5C27.7,-20.9,31.6,-13.6,39.2,-2.2C46.8,9.2,58.2,24.7,54,30.6C49.9,36.5,30.3,32.8,16.3,32.5C2.4,32.2,-5.8,35.3,-19.2,37.2C-32.7,39,-51.4,39.8,-58.3,31.7C-65.2,23.7,-60.4,7,-56.8,-9.5C-53.3,-25.9,-51,-42,-41.7,-56.9C-32.5,-71.9,-16.2,-85.7,-4.2,-80.8C7.9,-75.8,15.8,-52,21.7,-36.5Z" transform="translate(100 100)" />
</svg>
      <div><h1 className='prod'>OUR <span>PRODUCT</span> <hr /></h1></div> 
